    ...
    const loadInterventions = async () => {
      try {
        ...
        const response = await fetch(
          "/api/coordinator/intervention-analytics",
          {
            method: "GET",
            cache: "no-store",
          },
  ...
  return (
    <div className="flex flex-col flex-1 bg-[#F9FAFB] h-full overflow-hidden">
      <Topbar
        ...
        subtitle="Monitor the effectiveness of actions taken by faculty and mentors"
      />
              ...
              <tbody className="divide-y divide-[#E5E7EB]">
                {loading ? (
                  <tr>
                    <td
                      colSpan={5}
                      className="px-6 py-12 text-center text-sm font-medium text-[#6B7280]"
                    >
                        ...
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-4">
                            <div className="text-center">
                              <span className="block text-[10px] font-bold text-[#6B7280] uppercase tracking-widest mb-0.5">
                                Before
                              </span>
                            ...
                            <div
                              className={`ml-4 px-2 py-1 rounded text-[11px] font-bold flex items-center gap-1 ${isPositive ? "bg-emerald-50 text-[#10B981]" : "bg-gray-100 text-[#6B7280]"}`}
                            >
                              {isPositive ? "+" : ""}
                              {diff} pts
                            </div>
