  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        editingUser
          ? `/api/coordinator/users/${editingUser.id}`
  ...
  return (
    <div className="flex flex-col flex-1 bg-[#F9FAFB] h-full overflow-hidden">
      <Topbar
        ...
        subtitle="Create, edit, and assign roles for students, teachers, and mentors"
      />
            ...
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead className="bg-[#F9FAFB] border-b border-[#E5E7EB] sticky top-0 z-10">
                <tr>
                  ...
                  <th className="px-6 py-4 text-[11px] font-bold text-[#6B7280] uppercase tracking-wider text-right">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#E5E7EB]">
                {loading ? (
                  <tr>
                    <td
                      colSpan={5}
                      className="py-12 text-center text-[13px] font-semibold text-[#6B7280]"
                    >
                      Loading users...
                    </td>
                  </tr>
                  ...
                  filteredUsers.map((user) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        ...
                        <div className="text-[12px] font-semibold text-[#6B7280] mt-1.5">
                          {user.department}
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex px-2 py-0.5 rounded-md text-[11px] font-bold border ${user.status === "Active" ? "bg-emerald-50 text-[#10B981] border-emerald-200" : "bg-gray-50 text-[#6B7280] border-[#E5E7EB]"}`}
                        >
                          {user.status}
                        </span>
                      </td>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="pt-4 flex justify-end gap-3 border-t border-[#E5E7EB] mt-6">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="px-5 py-2 font-bold text-sm text-white bg-[#2563EB] hover:bg-blue-700 rounded-lg shadow-sm transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {submitting
                      ? "Saving..."
                      : editingUser
