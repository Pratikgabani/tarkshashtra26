...
export default function CoordinatorAnalytics() {
  ...
  return (
    <div className="flex flex-col flex-1 bg-[#F9FAFB]">
      <Topbar
        title="Aggregate Analytics & Patterns"
        subtitle="Automated insights and deep drill-downs into risk vectors"
      />
      ...
      <main className="flex-1 p-8 space-y-8 overflow-y-auto max-w-7xl">
        ...
        <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-2xl p-8 flex items-center justify-between shadow-sm">
          <div>
            <h2 className="text-sm font-bold text-[#6B7280] uppercase tracking-wider mb-2">
              Institution Health Score
            </h2>
            <div className="flex items-end gap-3">
              <span
                className={`text-5xl font-black ${riskPercentage > 20 ? "text-[#EF4444]" : "text-[#10B981]"}`}
              >
                {loading ? "..." : `${riskPercentage}%`}
              </span>
              <span className="text-[15px] font-bold text-[#111827] mb-1">
                of total student body is At-Risk
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-[#6B7280] font-medium">
                Automated observations based on recent data
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {insights.map((ins, i) => {
              ...
              return (
                <div
                  key={i}
                  className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-5 hover:border-blue-300 transition-colors"
                >
                  ...
                  <p className="text-sm font-semibold text-[#111827] leading-relaxed mb-4">
                    {ins.text}
                  </p>
                  <div className="p-3 bg-white rounded-lg border border-[#E5E7EB] border-l-4 border-l-[#2563EB]">
                    <p className="text-xs text-[#6B7280] font-semibold">
                      <span className="text-[#111827]">Suggested Action:</span>{" "}
                      {ins.action}
                    </p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-2xl shadow-sm p-6">
            ...
            <p className="text-xs text-[#6B7280] font-medium mb-6">
              At-Risk students by class block
            </p>
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <YAxis
                    ...
                    axisLine={false}
                    tickLine={false}
                    tick={{ fontSize: 11, fontWeight: 600, fill: "#111827" }}
                  />
                  <Tooltip
                    cursor={{ fill: "#F9FAFB" }}
                    contentStyle={{
          ...
          <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-2xl shadow-sm p-6">
            ...
            <p className="text-xs text-[#6B7280] font-medium mb-6">
              Percentage of at-risk students by department
            </p>
                ...
                .map((d) => (
                  <div key={d.department}>
                    <div className="flex justify-between items-center mb-1.5">
                      ...
                      <span
                        className={`text-[13px] font-bold ${d.riskRate > 25 ? "text-[#EF4444]" : "text-[#6B7280]"}`}
                      >
                        {d.riskRate}%
                      </span>
                    </div>
